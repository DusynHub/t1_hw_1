...
public abstract class BaseClient {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method, String path, @Nullable Map<String, Object> parameters, @Nullable T body) {
        ...
        ResponseEntity<Object> supplierServiceResponse;
        try {
            if (parameters != null) {
                supplierServiceResponse = rest.exchange(path, method, requestEntity, Object.class, parameters);
            } else {
                supplierServiceResponse = rest.exchange(path, method, requestEntity, Object.class);
            }
        } catch (HttpStatusCodeException e) {
            return ResponseEntity.status(e.getStatusCode()).body(e.getResponseBodyAsByteArray());
        }
        return prepareConsumerResponse(supplierServiceResponse);
    }
    ...
    private static ResponseEntity<Object> prepareConsumerResponse(ResponseEntity<Object> response) {
